export const IDO_ADDRESS = {
  ...
  [process.env.REACT_APP_SHARDEUM_APPSPHINX_CHAINID]: '0x52276A56C00FadCD5857DF9195a7304E06FeE622', //Shardeum IDO
...
export const WETH_TOKEN_ADDRESS = {
  ...
  [process.env.REACT_APP_LOCALHOST_CHAINID]: '',
  [process.env.REACT_APP_SHARDEUM_APPSPHINX_CHAINID]: '0x1DAcbaB28Decd115c8AA6F183877C71b942aE406',
...
export const USDT_TOKEN_ADDRESS = {
  ...
  [process.env.REACT_APP_LOCALHOST_CHAINID]: '',
  [process.env.REACT_APP_SHARDEUM_APPSPHINX_CHAINID]: '0xF8ADbB06C8015A4D68bd78f2c8cFBADA79e83A3D',
  [process.env.REACT_APP_SHMSPHINX_CHAINID]: '',
};
...
export const DEX_ROUTERV2_ADDRESS = {
  ...
  [process.env.REACT_APP_LOCALHOST_CHAINID]: '',
  [process.env.REACT_APP_SHARDEUM_APPSPHINX_CHAINID]: '0x28847a4C42D11E56b15BBA2Bb619889F4b3a97EC',
  [process.env.REACT_APP_SHMSPHINX_CHAINID]: '',
...
export const DEX_FACTORY_ADDRESS = {
  ...
  [process.env.REACT_APP_LOCALHOST_CHAINID]: '',
  [process.env.REACT_APP_SHARDEUM_APPSPHINX_CHAINID]: '0x151F63e1cD160241B04954B092a02A5D4c1834f3',
  [process.env.REACT_APP_SHMSPHINX_CHAINID]: '',
  [process.env.REACT_APP_MUMBAI_CHAINID]: ''
};
...
export const DEX_COINS = {
  ...
  'WSHM': { name: "WSHM", addresses: WETH_TOKEN_ADDRESS, isNative: false, icon: '_img/icon/shmx.png' },
  'SHMX': { name: "SHMX", addresses: PROJECT_MAIN_TOKEN_ADDRESS, isNative: false, icon: '_img/icon/shmx.png' },
  'sSHMX': { name: "sSHMX", addresses: LIQUID_STAKING_TOKEN_ADDRESS, isNative: false, icon: '_img/icon/shmx.png' },
